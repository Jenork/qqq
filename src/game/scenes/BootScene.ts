...
export class BootScene extends Phaser.Scene {
  ...
  create() {
    ...
    graphics.clear()
    graphics.fillStyle(0x24110d)
    graphics.fillRect(0, 4, 18, 4)
    graphics.fillStyle(0x8f989f)
    graphics.fillRect(4, 3, 12, 4)
    graphics.fillStyle(0xcfd6da)
    graphics.fillRect(14, 4, 10, 2)
    graphics.fillStyle(0x7a4a1f)
    graphics.fillRect(5, 7, 4, 5)
    graphics.generateTexture('weapon-pistol', 26, 12)

    graphics.clear()
    graphics.fillStyle(0x24110d)
    graphics.fillRect(0, 4, 28, 4)
    graphics.fillStyle(0x889097)
    graphics.fillRect(4, 3, 24, 4)
    graphics.fillStyle(0xcfd6da)
    graphics.fillRect(22, 4, 18, 2)
    graphics.fillStyle(0x7a4a1f)
    graphics.fillRect(10, 7, 5, 6)
    graphics.fillStyle(0x5b6066)
    graphics.fillRect(16, 2, 6, 3)
    graphics.generateTexture('weapon-shotgun', 42, 13)

...
export function AudioToggleButton() {
  ...
  return (
    <button
      ...
      className={cn(
        'fixed right-3 top-3 z-40 rounded-full border px-4 py-2.5 text-[11px] font-black uppercase tracking-[0.16em] shadow-[0_10px_24px_rgba(0,0,0,0.28)] backdrop-blur transition-colors sm:right-4 sm:top-4',
        audioMuted

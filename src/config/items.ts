...
export const ITEMS: GameItem[] = [
  ...
  },
  {
    ...
    category: 'weapon',
    label: 'Shotgun',
    description: 'Short-range spread blast activated after the daily check-in.',
  ...
  },
  {
    ...
    category: 'grenade',
    label: 'Fire Grenade',
    description: 'Ignites a scorched zone and unlocks after the 0.3 USDC arsenal payment.',
    defaultUnlocked: false,
